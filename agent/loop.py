...
class AgentLoop:
    ...
    def stop_reason(self) -> str | None:
        ...
        # Every journalled node counts toward the organizer's iteration cap,
        # including failures and preflight rejections. Training executions are
        # tracked separately; see agent.budget.
        ...
        # A tighter retry cap prevents one contract bug from consuming the
        # entire organizer allowance.
    ...
    def finish(self, stop: str) -> dict:
        ...
        summary = {
            "stop_reason": stop,
            # All journal records are organizer-counted iterations. Preflight
            # rejection still consumes zero training executions.
